//26.Write a program to create five threads with different priorities. Send two threads of the highest priority to sleep state. Check the aliveness of the threads and mark which thread is long lasting. 
package Experiment;
import java.util.concurrent.TimeUnit;
public class Experiment_26 {
